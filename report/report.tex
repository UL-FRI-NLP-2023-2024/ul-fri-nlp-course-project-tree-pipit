...
\Abstract{
This study explores the utilization of vast human conversation over web forums to train a multilingual fine-tune of existing large language models, efficient enough to train and run on consumer-grade hardware.
}
